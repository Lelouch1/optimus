    ...
    <section class="other-page">
      <?php include('modules/breadcrumb.php'); ?>
        <div class="main-screen ">
          <div class="container">
            <h1> УЗИ органов малого таза у женщин  </h1>
            <div class="text-img">
              <div class="text">
                <p>Это процесс подготовки к зачатию, включающий в себя полное обследование пары, выявление и лечение заболеваний, которые могут негативно сказаться на протекании беременности и на здоровье будущего малыша.
                  ...
                  <br>
                  <br> Наши квалифицированные гинекологи помогут спланировать беременность, в нашем центре пара сможет сдать все необходимые анализы для оптимального планирования беременности. Доверьте защиту своего женского здоровья профессиональным врачам! Хотите здорового малыша — планируйте беременность.</p><a href="#" class="btn">Записаться на приём</a> </div>
              <div class="image"><img src="img/ultrasound.png" alt="Планирование беременности">
                <div class="price-procedure">
